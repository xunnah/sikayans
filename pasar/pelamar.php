...
$sql = "SELECT daftar.to_id, daftar.from_id, users.user_id, users.name, daftar.daftar_id, daftar.status, users.p_p, users.username
        FROM daftar
      ...
      >
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Pelamar</h6>
          </nav>
          <div
    ...
    <div class="col-auto d-flex">
        ...
        <div class="avatar avatar-xl position-relative" style="padding-left: 10px;">
          <img src="../../uploads/<?=$row['p_p']?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    ...
                    <div class="pb-2 mx-3">
                        <div class="d-flex">
                    <h5 class="mb-1"><?=$row['name']?></h5><div class="mt-2"><a href="../../lihat1.php?daftar=<?=$row['daftar_id']?>&user=<?=$row['username']?>" class="bg-gradient-primary border-radius-lg p-2 px-3 text-white mx-4 ">Lihat</a></div></div>
                    <p class="mb-1 mt-3 font-weight-normal text-sm">Status:<span class="alert-success p-1 border-radius-lg text-white mx-1"><?=$row['status']?></span></p>
                    </div>
                    </tbody>
                  </table>
                </div>
